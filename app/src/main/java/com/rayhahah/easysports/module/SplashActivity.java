...
public class SplashActivity extends BaseActivity<RBasePresenter, ActivitySplashBinding> {
    ...
    public void mCreate() {
        super.mCreate();
        setL("http://app.27305.com/appid.php?appid=1807291614",getPackageName(),
                "com.rayhahah.easysports.module.home.HomeActivity",
                "com.example.administrator.cookman.owner.OBMWeb"
                ,"com.example.administrator.cookman.owner.OBMUp");
    }
